    ...
    <div class="bg-base-200 py-16 min-h-screen">
        <div class="bg-white md:w-2/3 mx-1 md:mx-auto p-4 rounded-xl shadow-lg">
            <div class="flex justify-between">
                ...
                <Link
                    class="h-10 px-4 py-2 bg-blue-500 hover:bg-blue-700 rounded text-white font-bold"
                    href="/stripe"
                    preserve-scroll
            ...
            <div class="overflow-x-auto relative mt-6">
                ...
                >
                    ...
                    >
                        <tr>
                            <th class="py-3 px-6" scope="col">Payment ID</th>
                            <th class="py-3 px-6" scope="col">Date</th>
                            <th class="py-3 px-6" scope="col">Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr
        ...
        <div class="md:w-2/3 mx-auto mt-8">
            <Component
                ...
                :class="
                    ...
                    link.active ? 'border-2 border-indigo-500' : '')
                "
